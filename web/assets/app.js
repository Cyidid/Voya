...
const filterOriginPicker = _debounce(function(val) {
  const el = document.getElementById('originInput');
  if (val.trim()) {
    delete el.dataset.zh;
    delete el.dataset.disambigDone;
  }
...
// ── 城市 Autocomplete ────────────────────────────────────────────────────────
// 格式：[城市名, 省份, 上级城市(可选), API传值(可选，默认=城市名)]
// 覆盖：直辖市/自治区首府、全部地级市、热门旅游县市、常见区名
const _CITY_DB = [
  // ── 直辖市
  ['北京','北京市','','北京'],['上海','上海市','','上海'],
  ['天津','天津市','','天津'],['重庆','重庆市','','重庆'],
  // ── 北京各区
  ['朝阳区','北京市','','北京朝阳区'],['海淀区','北京市','','北京海淀区'],
  ['东城区','北京市','','北京东城区'],['西城区','北京市','','北京西城区'],
  ['丰台区','北京市','','北京丰台区'],['石景山区','北京市','','北京石景山区'],
  ['通州区','北京市','','北京通州区'],['顺义区','北京市','','北京顺义区'],
  ['大兴区','北京市','','北京大兴区'],['昌平区','北京市','','北京昌平区'],
  ['房山区','北京市','','北京房山区'],['门头沟区','北京市','','北京门头沟区'],
  ['延庆区','北京市','','北京延庆区'],['怀柔区','北京市','','北京怀柔区'],
  ['密云区','北京市','','北京密云区'],['平谷区','北京市','','北京平谷区'],
  // ── 上海各区
  ['浦东新区','上海市','','上海浦东新区'],['黄浦区','上海市','','上海黄浦区'],
  ['徐汇区','上海市','','上海徐汇区'],['长宁区','上海市','','上海长宁区'],
  ['静安区','上海市','','上海静安区'],['普陀区','上海市','','上海普陀区'],
  ['虹口区','上海市','','上海虹口区'],['杨浦区','上海市','','上海杨浦区'],
  ['闵行区','上海市','','上海闵行区'],['宝山区','上海市','','上海宝山区'],
  ['嘉定区','上海市','','上海嘉定区'],['松江区','上海市','','上海松江区'],
  ['青浦区','上海市','','上海青浦区'],['奉贤区','上海市','','上海奉贤区'],
  ['金山区','上海市','','上海金山区'],['崇明区','上海市','','上海崇明区'],
  // ── 广东
  ['广州','广东省','','广州'],['深圳','广东省','','深圳'],
  ['珠海','广东省','','珠海'],['汕头','广东省','','汕头'],
  ['佛山','广东省','','佛山'],['韶关','广东省','','韶关'],
  ...
  ['潮州','广东省','','潮州'],['揭州','广东省','','揭州'],
  ['云浮','广东省','','云浮'],
  ['天河区','广东省','广州市','广州天河区'],['越秀区','广东省','广州市','广州越秀区'],
  ['海珠区','广东省','广州市','广州海珠区'],['荔湾区','广东省','广州市','广州荔湾区'],
  ['白云区','广东省','广州市','广州白云区'],['番禺区','广东省','广州市','广州番禺区'],
  ['黄埔区','广东省','广州市','广州黄埔区'],['花都区','广东省','广州市','广州花都区'],
  ['南沙区','广东省','广州市','广州南沙区'],['增城区','广东省','广州市','广州增城区'],
  ['从化区','广东省','广州市','广州从化区'],
  ['福田区','广东省','深圳市','深圳福田区'],['南山区','广东省','深圳市','深圳南山区'],
  ['罗湖区','广东省','深圳市','深圳罗湖区'],['宝安区','广东省','深圳市','深圳宝安区'],
  ['龙华区','广东省','深圳市','深圳龙华区'],['龙岗区','广东省','深圳市','深圳龙岗区'],
  ['盐田区','广东省','深圳市','深圳盐田区'],['光明区','广东省','深圳市','深圳光明区'],
  // ── 浙江
  ['杭州','浙江省','','杭州'],['宁波','浙江省','','宁波'],
  ['温州','浙江省','','温州'],['嘉兴','浙江省','','嘉兴'],
  ['湖州','浙江省','','湖州'],['绍兴','浙江省','','绍兴'],
  ['金华','浙江省','','金华'],['衢州','浙江省','','衢州'],
  ['舟山','浙江省','','舟山'],['台州','浙江省','','台州'],
  ['丽水','浙江省','','丽水'],['义乌','浙江省','金华市','义乌'],
  ['萧山区','浙江省','杭州市','杭州萧山区'],['余杭区','浙江省','杭州市','杭州余杭区'],
  ['西湖区','浙江省','杭州市','杭州西湖区'],['临安区','浙江省','杭州市','杭州临安区'],
  // ── 江苏
  ['南京','江苏省','','南京'],['苏州','江苏省','','苏州'],
  ['无锡','江苏省','','无锡'],['常州','江苏省','','常州'],
  ['南通','江苏省','','南通'],['连云港','江苏省','','连云港'],
  ['淮安','江苏省','','淮安'],['盐城','江苏省','','盐城'],
  ['扬州','江苏省','','扬州'],['镇江','江苏省','','镇江'],
  ['泰州','江苏省','','泰州'],['宿迁','江苏省','','宿迁'],
  ['徐州','江苏省','','徐州'],['昆山','江苏省','苏州市','昆山'],
  ['通州区','江苏省','南通市','南通通州区'],
  // ── 四川
  ['成都','四川省','','成都'],['绵阳','四川省','','绵阳'],
  ['德阳','四川省','','德阳'],['广元','四川省','','广元'],
  ...
  ['达州','四川省','','达州'],['巴中','四川省','','巴中'],
  ['雅安','四川省','','雅安'],['眉山','四川省','','眉山'],
  ['资阳','四川省','','资阳'],['攀枝花','四川省','','攀枝花'],
  ['泸州','四川省','','泸州'],['自贡','四川省','','自贡'],
  ['九寨沟','四川省','阿坝州','九寨沟'],['稻城','四川省','甘孜州','稻城亚丁'],
  ['峨眉山','四川省','乐山市','峨眉山'],
  // ── 湖南
  ['长沙','湖南省','','长沙'],['株洲','湖南省','','株洲'],
  ['湘潭','湖南省','','湘潭'],['衡阳','湖南省','','衡阳'],
  ['邵阳','湖南省','','邵阳'],['岳阳','湖南省','','岳阳'],
  ['常德','湖南省','','常德'],['张家界','湖南省','','张家界'],
  ['益阳','湖南省','','益阳'],['郴州','湖南省','','郴州'],
  ['永州','湖南省','','永州'],['怀化','湖南省','','怀化'],
  ['娄底','湖南省','','娄底'],['湘西','湖南省','','湘西'],
  // ── 湖北
  ...
  // ── 河南
  ['郑州','河南省','','郑州'],['开封','河南省','','开封'],
  ['洛阳','河南省','','洛阳'],['平顶山','河南省','','平顶山'],
  ['安阳','河南省','','安阳'],['鹤壁','河南省','','鹤壁'],
  ['新乡','河南省','','新乡'],['焦作','河南省','','焦作'],
  ['濮阳','河南省','','濮阳'],['许昌','河南省','','许昌'],
  ['漯河','河南省','','漯河'],['三门峡','河南省','','三门峡'],
  ['南阳','河南省','','南阳'],['商丘','河南省','','商丘'],
  ['信阳','河南省','','信阳'],['周口','河南省','','周口'],
  ['驻马店','河南省','','驻马店'],
  // ── 河北
  ['石家庄','河北省','','石家庄'],['唐山','河北省','','唐山'],
  ['秦皇岛','河北省','','秦皇岛'],['邯郸','河北省','','邯郸'],
  ['邢台','河北省','','邢台'],['保定','河北省','','保定'],
  ['张家口','河北省','','张家口'],['承德','河北省','','承德'],
  ['沧州','河北省','','沧州'],['廊坊','河北省','','廊坊'],
  ['衡水','河北省','','衡水'],
  // ── 陕西
  ['西安','陕西省','','西安'],['铜川','陕西省','','铜川'],
  ...
  ['阜新','辽宁省','','阜新'],['辽阳','辽宁省','','辽阳'],
  ['盘锦','辽宁省','','盘锦'],['铁岭','辽宁省','','铁岭'],
  ['朝阳','辽宁省','','辽宁朝阳'],['葫芦岛','辽宁省','','葫芦岛'],
  // ── 吉林
  ['长春','吉林省','','长春'],['吉林','吉林省','','吉林市'],
  ['四平','吉林省','','四平'],['辽源','吉林省','','辽源'],
  ['通化','吉林省','','通化'],['白山','吉林省','','白山'],
  ['松原','吉林省','','松原'],['白城','吉林省','','白城'],
  ['延边','吉林省','','延边'],
  // ── 黑龙江
  ['哈尔滨','黑龙江省','','哈尔滨'],['齐齐哈尔','黑龙江省','','齐齐哈尔'],
  ['鸡西','黑龙江省','','鸡西'],['鹤岗','黑龙江省','','鹤岗'],
  ['双鸭山','黑龙江省','','双鸭山'],['大庆','黑龙江省','','大庆'],
  ['伊春','黑龙江省','','伊春'],['佳木斯','黑龙江省','','佳木斯'],
  ['七台河','黑龙江省','','七台河'],['牡丹江','黑龙江省','','牡丹江'],
  ['黑河','黑龙江省','','黑河'],['绥化','黑龙江省','','绥化'],
  ['大兴安岭','黑龙江省','','大兴安岭'],
  // ── 内蒙古
  ['呼和浩特','内蒙古自治区','','呼和浩特'],['包头','内蒙古自治区','','包头'],
  ['乌海','内蒙古自治区','','乌海'],['赤峰','内蒙古自治区','','赤峰'],
  ['通辽','内蒙古自治区','','通辽'],['鄂尔多斯','内蒙古自治区','','鄂尔多斯'],
  ['呼伦贝尔','内蒙古自治区','','呼伦贝尔'],['巴彦淖尔','内蒙古自治区','','巴彦淖尔'],
  ['乌兰察布','内蒙古自治区','','乌兰察布'],['锡林郭勒','内蒙古自治区','','锡林郭勒'],
  // ── 云南
  ['昆明','云南省','','昆明'],['曲靖','云南省','','曲靖'],
  ['玉溪','云南省','','玉溪'],['保山','云南省','','保山'],
  ['昭通','云南省','','昭通'],['丽江','云南省','','丽江'],
  ['普洱','云南省','','普洱'],['临沧','云南省','','临沧'],
  ['大理','云南省','','大理'],['西双版纳','云南省','','西双版纳'],
  ['德宏','云南省','','德宏'],['怒江','云南省','','怒江'],
  ['迪庆','云南省','','迪庆'],['香格里拉','云南省','迪庆州','香格里拉'],
  // ── 贵州
  ['贵阳','贵州省','','贵阳'],['六盘水','贵州省','','六盘水'],
  ['遵义','贵州省','','遵义'],['安顺','贵州省','','安顺'],
  ['毕节','贵州省','','毕节'],['铜仁','贵州省','','铜仁'],
  ['凯里','贵州省','黔东南州','凯里'],
  // ── 广西
  ['南宁','广西壮族自治区','','南宁'],['柳州','广西壮族自治区','','柳州'],
  ['桂林','广西壮族自治区','','桂林'],['梧州','广西壮族自治区','','梧州'],
  ['北海','广西壮族自治区','','北海'],['防城港','广西壮族自治区','','防城港'],
  ['钦州','广西壮族自治区','','钦州'],['贵港','广西壮族自治区','','贵港'],
  ['玉林','广西壮族自治区','','玉林'],['百色','广西壮族自治区','','百色'],
  ['贺州','广西壮族自治区','','贺州'],['河池','广西壮族自治区','','河池'],
  ['来宾','广西壮族自治区','','来宾'],['崇左','广西壮族自治区','','崇左'],
  // ── 海南
  ['海口','海南省','','海口'],['三亚','海南省','','三亚'],
  ['三沙','海南省','','三沙'],['儋州','海南省','','儋州'],
  ['琼海','海南省','','琼海'],['万宁','海南省','','万宁'],
  ...
  ['晋中','山西省','','晋中'],['运城','山西省','','运城'],
  ['忻州','山西省','','忻州'],['临汾','山西省','','临汾'],
  ['吕梁','山西省','','吕梁'],['平遥','山西省','晋中市','平遥'],
  // ── 甘肃
  ['兰州','甘肃省','','兰州'],['嘉峪关','甘肃省','','嘉峪关'],
  ['金昌','甘肃省','','金昌'],['白银','甘肃省','','白银'],
  ['天水','甘肃省','','天水'],['武威','甘肃省','','武威'],
  ['张掖','甘肃省','','张掖'],['平凉','甘肃省','','平凉'],
  ['酒泉','甘肃省','','酒泉'],['庆阳','甘肃省','','庆阳'],
  ...
  ['塔城','新疆维吾尔自治区','','塔城'],
  ['阿勒泰','新疆维吾尔自治区','','阿勒泰'],
  ['那拉提','新疆维吾尔自治区','伊犁州','那拉提'],
  // ── 西藏
  ['拉萨','西藏自治区','','拉萨'],['日喀则','西藏自治区','','日喀则'],
  ['昌都','西藏自治区','','昌都'],['林芝','西藏自治区','','林芝'],
  ['山南','西藏自治区','','山南'],['那曲','西藏自治区','','那曲'],
  ['阿里','西藏自治区','','阿里'],
  // ── 青海
  ['西宁','青海省','','西宁'],['海东','青海省','','海东'],
  ['青海湖','青海省','','青海湖'],['茶卡','青海省','','茶卡盐湖'],
  // ── 宁夏
  ['银川','宁夏回族自治区','','银川'],['石嘴山','宁夏回族自治区','','石嘴山'],
  ['吴忠','宁夏回族自治区','','吴忠'],['固原','宁夏回族自治区','','固原'],
  ['中卫','宁夏回族自治区','','中卫'],
  // ── 港澳台
  ['香港','香港特别行政区','','香港'],['澳门','澳门特别行政区','','澳门'],
  ['台北','台湾省','','台北'],['台中','台湾省','','台中'],
  ['台南','台湾省','','台南'],['高雄','台湾省','','高雄'],
  ['花莲','台湾省','','花莲'],['垦丁','台湾省','屏东县','垦丁'],
  // ── 热门国际城市（常用中文名）
  ['东京','日本','','东京'],['大阪','日本','','大阪'],['京都','日本','','京都'],
  ['北海道','日本','','北海道'],['冲绳','日本','','冲绳'],['奈良','日本','','奈良'],
  ['首尔','韩国','','首尔'],['釜山','韩国','','釜山'],['济州岛','韩国','','济州岛'],
  ['新加坡','新加坡','','新加坡'],
  ['曼谷','泰国','','曼谷'],['清迈','泰国','','清迈'],['普吉岛','泰国','','普吉岛'],
  ['芭提雅','泰国','','芭提雅'],['苏梅岛','泰国','','苏梅岛'],
  ['吉隆坡','马来西亚','','吉隆坡'],['槟城','马来西亚','','槟城'],
  ['巴厘岛','印度尼西亚','','巴厘岛'],['雅加达','印度尼西亚','','雅加达'],
  ['河内','越南','','河内'],['胡志明市','越南','','胡志明市'],['岘港','越南','','岘港'],
  ['马尔代夫','马尔代夫','','马尔代夫'],
  ['迪拜','阿联酋','','迪拜'],['阿布扎比','阿联酋','','阿布扎比'],
  ['伊斯坦布尔','土耳其','','伊斯坦布尔'],['开罗','埃及','','开罗'],
  ['巴黎','法国','','巴黎'],['尼斯','法国','','尼斯'],['里昂','法国','','里昂'],
  ['伦敦','英国','','伦敦'],['爱丁堡','英国','','爱丁堡'],
  ['罗马','意大利','','罗马'],['米兰','意大利','','米兰'],['威尼斯','意大利','','威尼斯'],
  ['佛罗伦萨','意大利','','佛罗伦萨'],['那不勒斯','意大利','','那不勒斯'],
  ['巴塞罗那','西班牙','','巴塞罗那'],['马德里','西班牙','','马德里'],
  ['塞维利亚','西班牙','','塞维利亚'],['格拉纳达','西班牙','','格拉纳达'],
  ['阿姆斯特丹','荷兰','','阿姆斯特丹'],['维也纳','奥地利','','维也纳'],
  ['布拉格','捷克','','布拉格'],['布达佩斯','匈牙利','','布达佩斯'],
  ['哥本哈根','丹麦','','哥本哈根'],['斯德哥尔摩','瑞典','','斯德哥尔摩'],
  ['苏黎世','瑞士','','苏黎世'],['日内瓦','瑞士','','日内瓦'],['因特拉肯','瑞士','','因特拉肯'],
  ['里斯本','葡萄牙','','里斯本'],
  ['雅典','希腊','','雅典'],['圣托里尼','希腊','','圣托里尼'],['克里特岛','希腊','','克里特岛'],
  ['悉尼','澳大利亚','','悉尼'],['墨尔本','澳大利亚','','墨尔本'],
  ['布里斯班','澳大利亚','','布里斯班'],['黄金海岸','澳大利亚','','黄金海岸'],
  ['奥克兰','新西兰','','奥克兰'],['皇后镇','新西兰','','皇后镇'],
  ['纽约','美国','','纽约'],['洛杉矶','美国','','洛杉矶'],['旧金山','美国','','旧金山'],
  ['拉斯维加斯','美国','','拉斯维加斯'],['夏威夷','美国','','夏威夷'],
  ['迈阿密','美国','','迈阿密'],['芝加哥','美国','','芝加哥'],
  ['多伦多','加拿大','','多伦多'],['温哥华','加拿大','','温哥华'],
  ['圣地亚哥','智利','','智利圣地亚哥'],['圣地亚哥','西班牙','','西班牙圣地亚哥'],
  ['开普敦','南非','','开普敦'],['迪拜','阿联酋','','迪拜'],
];

// 国家/省份 中→英 对照（用于英文模式下的城市下拉副标题）
const _PROVINCE_EN = {
  '日本':'Japan','韩国':'South Korea','新加坡':'Singapore',
  '泰国':'Thailand','马来西亚':'Malaysia','印度尼西亚':'Indonesia',
  '越南':'Vietnam','菲律宾':'Philippines','印度':'India',
  '斯里兰卡':'Sri Lanka','马尔代夫':'Maldives','尼泊尔':'Nepal',
  '中国':'China','台湾省':'Taiwan','香港特别行政区':'Hong Kong','澳门特别行政区':'Macau',
  '澳大利亚':'Australia','新西兰':'New Zealand',
  '法国':'France','英国':'UK','意大利':'Italy','西班牙':'Spain',
  '荷兰':'Netherlands','奥地利':'Austria','捷克':'Czech Republic',
  '匈牙利':'Hungary','丹麦':'Denmark','瑞典':'Sweden','瑞士':'Switzerland',
  '葡萄牙':'Portugal','希腊':'Greece','土耳其':'Turkey','冰岛':'Iceland',
  '埃及':'Egypt','阿联酋':'UAE','以色列':'Israel',
  '肯尼亚':'Kenya','摩洛哥':'Morocco','南非':'South Africa',
  '美国':'USA','加拿大':'Canada','墨西哥':'Mexico',
  '巴西':'Brazil','阿根廷':'Argentina','秘鲁':'Peru','智利':'Chile',
};

// 搜索城市（拼音/汉字模糊匹配，返回最多8条）
function _searchCities(query) {
  if (!query || query.length < 1) return [];
  const q = query.trim().toLowerCase();
  const cityMap = I18N['en']?.city_map || {};
  const results = [];
  const seen = new Set();
  for (const [name, province, parent, dest] of _CITY_DB) {
    const key = dest || name;
    if (seen.has(key)) continue;
    const enName = (cityMap[name] || '').toLowerCase();
    // 中文匹配城市名/省份，英文匹配英文名
    if (name.includes(q) || province.includes(q) || parent.includes(q) || enName.includes(q)) {
      seen.add(key);
      results.push({ name, province, parent, dest: dest || name, enName: cityMap[name] || '' });
...
// Autocomplete 状态
// ── Autocomplete（全局 fixed 浮层，不受 overflow:hidden 裁剪）────────────────
let _acActiveField = null;
let _acActiveIdx   = -1;

// 键盘导航：方向键 + Enter
function onCityKeydown(field, e) {
  const ac = document.getElementById('globalAC');
  ...
  if (e.key === 'ArrowDown') {
    e.preventDefault();
    _acActiveIdx = (_acActiveIdx + 1) % items.length;
  } else if (e.key === 'ArrowUp') {
    e.preventDefault();
    _acActiveIdx = (_acActiveIdx - 1 + items.length) % items.length;
...
function onCityInput(field, inputEl) {
  const val = inputEl.value.trim();
  // 打字时清除旧的选择器选中值
  if (val) {
    delete inputEl.dataset.zh;
    delete inputEl.dataset.city;
    delete inputEl.dataset.disambigDone;
    // 关闭弹窗选择器（避免遮挡下拉）
    document.getElementById('destPicker').classList.remove('open');
    document.getElementById('originPicker').classList.remove('open');
  }
  _acActiveField = field;
  _showAC(field, inputEl, val);
}

function onCityBlur(field) {
  // 延迟关闭，让 mousedown 选择先触发
  setTimeout(() => _hideAC(), 200);
}

function _showAC(field, inputEl, query) {
  const ac = document.getElementById('globalAC');
  if (!query) { _hideAC(); return; }

  const results = _searchCities(query);
  if (!results.length) { _hideAC(); return; }

  _acActiveIdx = -1;   // 每次新搜索重置键盘选中
  ...
  ac.innerHTML = results.map(r => {
    // 英文模式：主显示英文名（有则用），副标题加中文名
    const displayName = isEn && r.enName ? r.enName : r.name;
    const subCn = isEn && r.enName ? ` · ${r.name}` : '';
    const provinceTxt = isEn ? (_PROVINCE_EN[r.province] || r.province) : r.province;
    const parentTxt   = isEn ? (_PROVINCE_EN[r.parent]   || r.parent)   : r.parent;
    const sub = (parentTxt ? `${provinceTxt} · ${parentTxt}` : provinceTxt) + subCn;
    const safeName = r.name.replace(/'/g, "\\'");
    const safeDest = r.dest.replace(/'/g, "\\'");
    const safeProv = r.province.replace(/'/g, "\\'");
    const highlightQ = isEn && r.enName ? query : query;
    return `<div class="ac-item" onmousedown="selectACItem('${field}','${safeName}','${safeProv}','${safeDest}')">
      <span class="ac-item-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><circle cx="12" cy="9" r="2.5"/></svg></span>
      <div>
        <div class="ac-item-main">${_highlight(displayName, query)}</div>
...
function selectACItem(field, name, province, dest) {
  const el = document.getElementById(field === 'dest' ? 'destInput' : 'originInput');
  el.value = name;
  el.dataset.zh = dest;
  el.dataset.disambigDone = '1';  // 已从列表选择，无需再次消歧义
  _hideAC();
  if (field === 'dest') _autoSwitchTransport(dest);
  // 关闭弹窗选择器（如果还开着）
  document.getElementById('destPicker').classList.remove('open');
  document.getElementById('originPicker').classList.remove('open');
}
...
// 已知的完整城市集合（不需要消歧义）
const _KNOWN_CITIES = new Set([
  '上海','北京','广州','深圳','成都','杭州','武汉','重庆','西安','南京',
  '天津','苏州','厦门','长沙','青岛','大连','济南','哈尔滨','昆明','郑州',
  '香港','台北','澳门','三亚','桂林','张家界','丽江','大理','西藏','拉萨',
  '敦煌','黄山','九寨沟','稻城亚丁','乌镇','周庄','西湖','峨眉山','泰山',
  '华山','张掖','喀什','银川','贵阳','南宁','福州','合肥','石家庄','太原',
  '兰州','西宁','乌鲁木齐','海口','珠海','汕头','温州','宁波','南昌',
  '长春','沈阳','东京','大阪','京都','首尔','新加坡','曼谷','普吉岛',
  '巴厘岛','马尔代夫','迪拜','伊斯坦布尔','开罗','悉尼','巴黎','伦敦',
  '罗马','巴塞罗那','阿姆斯特丹','维也纳','布拉格','哥本哈根','苏黎世',
  '里斯本','纽约','洛杉矶','旧金山','芝加哥','多伦多','温哥华','墨尔本',
  '奥克兰','首尔','吉隆坡','河内','胡志明市','雅加达','迪拜','特拉维夫',
]);

// 区/县/镇级后缀（出现则说明可能是子城市级别地名）
const _DISTRICT_SUFFIXES = ['区','县','镇','街道','城','乡','岛','湾','港','坝','岗','村'];

// 检查是否需要消歧义，返回：
//   { type:'list', options:[...] }  — 预定义多选
//   { type:'freeform' }             — 未知短地名，需补充省市
//   null                            — 不需要消歧义
function _checkAmbiguity(name) {
  if (!name) return null;
  const d = name.trim();

  // 已是完整地址（含省/市/自治区）→ 不歧义
  if (/省|自治区|特别行政区/.test(d)) return null;

  // 在已知完整城市库中 → 不歧义
  if (_KNOWN_CITIES.has(d)) return null;

  // 已是预处理过的消歧义结果（含"市"+"区"组合）→ 不歧义
  for (const opts of Object.values(_AMBIGUOUS_PLACES)) {
    if (opts.some(o => o.dest === d || o.display === d)) return null;
  }

  // 预定义歧义表精确命中
  if (_AMBIGUOUS_PLACES[d]) return { type: 'list', options: _AMBIGUOUS_PLACES[d] };

  // 自动检测：短名称（≤3字）或含区县级后缀 → 需要补充省市
  const isShort = d.length <= 3;
  const hasDistrictSuffix = _DISTRICT_SUFFIXES.some(s => d.endsWith(s));
  if (isShort || hasDistrictSuffix) return { type: 'freeform' };
...
let _disambigTargetEl = null;   // 当前正在消歧义的输入框元素

function openDisambig(name, result, inputEl, callback) {
  _disambigCallback = callback;
  _disambigTargetEl = inputEl;
  document.getElementById('disambigQuery').textContent = name;

  if (result.type === 'list') {
    // 预定义多选模式
    const isMulti = result.options.length > 1;
    document.getElementById('disambigTitle').textContent = isMulti
      ? _L('请确认地点', 'Please clarify location')
      : _L('确认所在城市', 'Confirm location');
    document.getElementById('disambigSub').innerHTML = isMulti
      ? `「${name}」${_L('在多个省市都有同名地点，请选择：', ' exists in multiple regions — please choose:')}`
      : `「${name}」${_L('是以下地点的简称，请确认：', ' is an abbreviated name — please confirm:')}`;

    document.getElementById('disambigOptions').innerHTML = result.options.map((opt, i) =>
      `<button class="disambig-opt" onclick="selectDisambigOpt(${i})">
    ...
    // 自由输入模式：让用户补充省/市
    document.getElementById('disambigTitle').textContent = _L('请补充省市信息', 'Please specify the city/province');
    document.getElementById('disambigSub').innerHTML =
      `「${name}」${_L('在多个地方都有，请输入所在省份或城市：', ' exists in multiple places — enter the province or city:')}`;

    document.getElementById('disambigOptions').innerHTML =
      `<div style="display:flex;gap:8px;margin-top:4px">
        <input id="disambigCityInput" class="disambig-city-input"
          placeholder="${_L('如：东莞、广东省、广东东莞', 'e.g. Dongguan, Guangdong')}"
          oninput="" autocomplete="off" maxlength="20">
        <button class="disambig-confirm-btn" onclick="selectDisambigFreeform()">${_L('确认', 'Confirm')}</button>
      </div>`;

    // 回车确认
    setTimeout(() => {
      const inp = document.getElementById('disambigCityInput');
      if (inp) inp.addEventListener('keydown', e => { if (e.key === 'Enter') selectDisambigFreeform(); });
    }, 50);
  }
...
function selectDisambigOpt(idx) {
  const query = document.getElementById('disambigQuery').textContent;
  const opts = _AMBIGUOUS_PLACES[query];
  if (!opts || !opts[idx]) return closeDisambig(true);
  const chosen = opts[idx];

  if (_disambigTargetEl) {
    _disambigTargetEl.value = chosen.display;
    _disambigTargetEl.dataset.zh = chosen.dest;
    _disambigTargetEl.dataset.city = chosen.city;
  }
  document.getElementById('disambigModal').classList.remove('open');
  if (_disambigCallback) { _disambigCallback(chosen.dest); _disambigCallback = null; }
}

function selectDisambigFreeform() {
  const cityInput = document.getElementById('disambigCityInput');
  const city = cityInput ? cityInput.value.trim() : '';
  const query = document.getElementById('disambigQuery').textContent;
  const combined = city ? `${city}${query}` : query;

  if (_disambigTargetEl) {
    _disambigTargetEl.value = combined;
    _disambigTargetEl.dataset.zh = combined;
    delete _disambigTargetEl.dataset.city;
  }
  document.getElementById('disambigModal').classList.remove('open');
  if (_disambigCallback) { _disambigCallback(combined); _disambigCallback = null; }
}
...
async function doSearch() {
  ...
  // ── 出发地消歧义（先检查，因为出发地在前）──────────────────────────────
  const originVal = originEl.dataset.zh || originEl.value.trim();
  if (originVal && !originEl.dataset.disambigDone) {
    const originAmbig = _checkAmbiguity(originVal);
    if (originAmbig) {
      openDisambig(originVal, originAmbig, originEl, (resolved) => {
        originEl.dataset.disambigDone = '1';
        doSearch();
      });
      return;
    }
  }
  delete originEl.dataset.disambigDone;

  // ── 目的地消歧义 ────────────────────────────────────────────────────────
  if (!destEl.dataset.disambigDone) {
    const destAmbig = _checkAmbiguity(dest);
    if (destAmbig) {
      openDisambig(dest, destAmbig, destEl, (resolved) => {
        destEl.dataset.disambigDone = '1';
        doSearch();
      });
      return;
    }
  }
  delete destEl.dataset.disambigDone;
  ...
  let label;
  if (_lang === 'en') {
    const originPart = origin ? `Departing from ${origin} by ${travelMode}, ` : '';
    const specialPart = special && special !== '无' ? `, ${special}` : '';
    label = `${originPart}${numPeople}-person ${group} trip to ${dest} for ${days} days, ` +
      `interests: ${interests.join(', ') || 'sightseeing'}, budget: ${budget}${specialPart}, depart ${startDate}.`;
  } else {
    const prefix = origin ? `从${origin}乘${travelMode}出发，` : `乘${travelMode}，`;
    label = `${prefix}我想去${dest}玩${days}天，共${numPeople}人${group}出行，` +
  ...
  await callAPI({
    ...
    start_date: startDate, agent_type: curSys, language: _lang,
  }, label);
}
...
function updateDestHint() {
  ...
  if (curSys === 'rule_based') {
    destInput.placeholder = _lang === 'en' ? 'Paris, Tokyo, New York...' : '巴黎、东京、纽约...';
    if (hint) hint.textContent = _lang === 'en' ? '25 supported cities' : '支持 25 个固定城市';
  } else {
    destInput.placeholder = _lang === 'en' ? 'Paris, Dubai, Seoul...' : '巴黎、迪拜、首尔...';
    if (hint) hint.textContent = _lang === 'en' ? 'Enter any city or region' : '点击选择或直接输入城市';
  }
}
    ...
    while (true) {
      ...
      for (const line of lines) {
        ...
        if (evt.done) {
          ...
          const _msgCity = _lang === 'en' ? ((I18N[_lang]?.city_map || {})[params.city] || params.city) : params.city;
          const _msgGroup = _lang === 'en' ? ({单人:'Solo',情侣:'Couple',夫妻:'Couple',朋友:'Friends',家庭:'Family',同事:'Team'}[params.group] || params.group) : params.group;
          const _msgLabel = _lang === 'en' ? `Itinerary: ${_msgCity} ${params.days}d · ${_msgGroup}` : `行程已生成：${params.city} ${params.days} 天 · ${params.group}`;
          addMsg('a', _msgLabel);
...
function _renderResultHeader(params) {
  ...
  const dOrigin = _lang === 'en' && params.origin ? (cityMap[params.origin] || params.origin) : params.origin;
  const dayWord = _lang === 'en' ? 'd' : '天';
  const route = params.origin ? `${dOrigin} → ${dCity}` : dCity;
  document.getElementById('resultTitle').textContent = `${route} · ${params.days}${dayWord}`;
  document.getElementById('itinHeadTitle').textContent = `${dCity} ${params.days}${dayWord}`;
  // 票务快捷入口
...
function _updateResultChips(params, data) {
  const sysNamesZh = { goal_based:'实时规划', supervised:'偏好匹配', rule_based:'经典规划' };
  const sysNamesEn = { goal_based:'Live Planner', supervised:'Smart Recommender', rule_based:'Classic Planner' };
  const sysName = _lang === 'en' ? (sysNamesEn[params.agent_type] || params.agent_type) : (sysNamesZh[params.agent_type] || params.agent_type);
  const _budgetEn = { 低:'Budget', 中:'Mid-range', 高:'Luxury' };
  const _budgetDisp = _lang === 'en' ? (_budgetEn[params.budget] || params.budget) : ({ 低:'经济型', 中:'舒适型', 高:'奢华型' }[params.budget] || params.budget);
  const _groupEn = { 单人:'Solo', 情侣:'Couple', 夫妻:'Couple', 朋友:'Friends', 家庭:'Family', 同事:'Team' };
  const _groupDisp = _lang === 'en' ? (_groupEn[params.group] || params.group) : params.group;
  const _cityMap = I18N[_lang]?.city_map || {};
  const _dOrigin = _lang === 'en' && params.origin ? (_cityMap[params.origin] || params.origin) : params.origin;
  const _ppl = _lang === 'en' ? 'ppl' : '人';
  const _depart = _lang === 'en' ? `from ${_dOrigin}` : `${_dOrigin}出发`;
  const chips = document.getElementById('resultChips');
  chips.innerHTML = `
    <span class="chip agent">${sysName}</span>
    <span class="chip">${_budgetDisp}</span>
    <span class="chip">${_groupDisp} · ${params.num_people}${_ppl}</span>
    ${params.origin ? `<span class="chip">${_depart}</span>` : ''}
    ${data.processing_time ? `<span class="chip">${parseFloat(data.processing_time).toFixed(1)}s</span>` : ''}
    ${params.agent_type === 'goal_based' ? '<span class="chip web">Web-connected</span>' : ''}
    ${params.agent_type === 'supervised' ? '<span class="chip ml">ML Model</span>' : ''}
    ${params.agent_type === 'rule_based' ? '<span class="chip info">Rule Engine</span>' : ''}
  `;
}
...
//  English weather table (mirrors _CLIMATE)
const _CLIMATE_EN = {
  '东京':  {spring:'Cherry blossom season (Mar–Apr), 10–18°C, carry an umbrella',summer:'Hot & humid, 28–35°C, stay hydrated',autumn:'Fall foliage (Nov), pleasant 12–20°C',winter:'Dry & cold, 2–8°C, Mt. Fuji snow views'},
  '大阪':  {spring:'Cherry blossoms, 10–17°C, great for walking',summer:'Hot & humid, 30–35°C, seek indoor relief',autumn:'Cool & dry, best sightseeing season',winter:'Occasional snow, 4–10°C'},
  '京都':  {spring:'Peak cherry blossoms, 8–18°C, very crowded',summer:'Sultry & rainy, 28–36°C',autumn:'Stunning fall foliage, 10–20°C',winter:'Serene snowy scenery, 1–8°C'},
  '首尔':  {spring:'Cherry & pear blossoms, 10–18°C',summer:'Hot & rainy, 25–33°C, monsoon season',autumn:'Clear skies, ideal travel season',winter:'Dry & very cold, −6 to 3°C, dress warmly'},
  '新加坡':{spring:'Year-round 28–33°C, occasional thunderstorms',summer:'Hot year-round, slightly drier Jul–Aug',autumn:'Oct–Dec northeast monsoon, more rain',winter:'Still hot in Dec–Feb, occasional cool breezes'},
  '曼谷':  {spring:'Hottest months (Mar–Apr), 34–38°C',summer:'Rainy season May–Oct, afternoon downpours',autumn:'Late rainy season, temperatures ease to 30°C',winter:'Best season Nov–Feb, 25–32°C'},
  '普吉岛':{spring:'Late dry season, 28–34°C, good sea conditions',summer:'Rainy season, rough waves, some beaches closed',autumn:'Rainy season, consider Andaman Sea spots',winter:'Dry season, best beach weather, 28–32°C'},
  '马尔代夫':{spring:'Late dry season, crystal-clear water, excellent visibility',summer:'Rainy season starts May, choppy seas',autumn:'Monsoon, occasional swells, lower prices',winter:'Dry season, best for diving & snorkeling'},
  '迪拜':  {spring:'Comfortable, 23–33°C, best for outdoor activities',summer:'Extreme heat, 38–45°C, mostly indoor activities',autumn:'Cooling down, 28–37°C',winter:'Best travel season, 14–24°C'},
  '伊斯坦布尔':{spring:'Warm & windy, 12–20°C, some rain',summer:'Sunny & dry, 25–32°C',autumn:'Pleasant, shoulder season great value',winter:'Cold & rainy, 3–9°C, occasional snow'},
  '巴厘岛':{spring:'Dry season, 26–30°C, perfect for exploring',summer:'Dry & sunny, best sea views',autumn:'Rainy season begins, bring rain gear',winter:'Rainy season Dec–Feb, still warm ~27°C'},
  '巴黎':  {spring:'Mild & rainy, 10–18°C, tulips in bloom',summer:'Warm & sunny, 22–28°C, peak tourist season',autumn:'Cool, 12–18°C, best museum atmosphere',winter:'Cold & grey, 3–8°C, festive atmosphere'},
  '伦敦':  {spring:'Partly cloudy, 9–15°C, frequent showers',summer:'Warm & pleasant, 18–24°C, long daylight hours',autumn:'Cool & rainy, 10–15°C',winter:'Cold & damp, 3–8°C'},
  '罗马':  {spring:'Warm & lovely, 14–20°C, peak tourist season',summer:'Hot & dry, 30–35°C, very crowded',autumn:'Comfortable, excellent travel season',winter:'Mild & rainy, 6–12°C'},
  '巴塞罗那':{spring:'Mild, 15–20°C, fewer crowds',summer:'Hot & dry, 28–32°C, beach season',autumn:'Pleasant, 18–24°C, festival season',winter:'Mild, 9–14°C'},
  '阿姆斯特丹':{spring:'Tulip season (Apr), 8–15°C, windy',summer:'Warm, 18–24°C, long days',autumn:'Cool & rainy, 10–15°C',winter:'Cold, 0–6°C, occasional snow'},
  '维也纳':{spring:'Mild, 10–18°C, concert season',summer:'Warm, 20–28°C, outdoor music festivals',autumn:'Cool, 10–16°C, wine harvest season',winter:'Cold, 0–5°C, famous Christmas markets'},
  '布拉格':{spring:'Mild, 10–18°C, tourist season begins',summer:'Warm, 22–28°C, beer festival season',autumn:'Cool, 8–14°C, low season',winter:'Cold, −2 to 4°C, fairytale snow scenery'},
  '里斯本':{spring:'Warm, 15–22°C, best for hiking',summer:'Hot & dry, 28–35°C',autumn:'Mild & rainy, 16–22°C',winter:'Mild, 10–15°C, one of Europe\'s warmest winters'},
  '悉尼':  {spring:'Southern spring (Sep–Nov), 18–24°C, flowers blooming',summer:'Southern summer (Dec–Feb), 26–32°C, beach season',autumn:'Southern autumn (Mar–May), 15–22°C, comfortable',winter:'Southern winter (Jun–Aug), 10–16°C, cool & dry'},
  '纽约':  {spring:'Mild, 10–20°C, cherry blossoms in Central Park',summer:'Hot & humid, 25–33°C, busy outdoor season',autumn:'Crisp & golden, best travel season',winter:'Cold & snowy, −2 to 6°C, festive vibes'},
  '广州':  {spring:'Warm & rainy, 18–26°C, humid fog season',summer:'Hot & rainy, 30–37°C, heat precautions needed',autumn:'Clear & crisp, 22–30°C, best travel season',winter:'Mild & dry, 10–18°C, occasional cold snaps'},
  '开罗':  {spring:'Dry & warm, 18–30°C, occasional sandstorms',summer:'Extremely hot & dry, 35–43°C, go early morning or evening',autumn:'Cooling down, 22–33°C, peak tourist season',winter:'Best travel season, 10–20°C, cool evenings'},
  '哥本哈根':{spring:'Cool & windy, 6–13°C, days lengthening',summer:'Mild & pleasant, 16–22°C, best Nordic season',autumn:'Cool & rainy, 8–14°C, fairy-tale feel',winter:'Cold & dark, 0–4°C, lively Christmas markets'},
  '苏黎世':{spring:'Fresh & changeable, 7–15°C, Alps still snow-capped',summer:'Warm & comfortable, 18–26°C, great lakeside swimming',autumn:'Colourful foliage, 8–16°C, wine festival season',winter:'Cold & snowy, −1 to 4°C, ski season'},
};
...
const _VISA_EN = {
  '东京':'🟡 Tourist visa required · Apply ~5–7 business days in advance',
  '大阪':'🟡 Tourist visa required · Apply ~5–7 business days in advance',
  '京都':'🟡 Tourist visa required · Apply ~5–7 business days in advance',
  '首尔':'🟡 K-ETA electronic authorization required · Visa-free in some cases',
  '新加坡':'🟢 Visa-free for 30 days',
  '曼谷':'🟢 Visa-free for 30 days (China–Thailand mutual exemption)',
  '普吉岛':'🟢 Visa-free for 30 days (China–Thailand mutual exemption)',
  '马尔代夫':'🟢 Visa on arrival, free for 30 days',
  '迪拜':'🟡 Visa on arrival or e-Visa (~¥200–400)',
  '巴厘岛':'🟡 Visa on arrival (~¥220)',
  '伊斯坦布尔':'🟡 e-Visa online · Apply in advance (~$51)',
  '巴黎':'🔴 Schengen visa · Apply at least 3 months ahead',
  '伦敦':'🔴 UK Standard Visitor Visa (~¥1,100+)',
  '罗马':'🔴 Schengen visa · Apply at least 3 months ahead',
  '巴塞罗那':'🔴 Schengen visa · Apply at least 3 months ahead',
  '阿姆斯特丹':'🔴 Schengen visa · Apply at least 3 months ahead',
  '维也纳':'🔴 Schengen visa · Apply at least 3 months ahead',
  '布拉格':'🔴 Schengen visa · Apply at least 3 months ahead',
  '里斯本':'🔴 Schengen visa · Apply at least 3 months ahead',
  '悉尼':'🟡 ETA electronic travel authority (~AUD 20)',
  '纽约':'🔴 US B-2 Tourist Visa (~¥1,200 + in-person interview)',
  '广州':'🟢 Domestic city · No visa required',
  '开罗':'🟡 e-Visa online · ~$25, apply in advance',
  '哥本哈根':'🔴 Schengen visa · Apply at least 3 months ahead',
  '苏黎世':'🔴 Schengen visa · Apply at least 3 months ahead',
};
...
function renderSide(data, params) {
  ...
  if (params.agent_type === 'supervised') {
    ...
    const acc  = data.model_accuracy  || 0.845;
    const dsz  = data.dataset_size    || 10000;
    const _recTypeEn = {0:'Budget Sightseeing',1:'Cultural Deep Dive',2:'Luxury Experience',3:'Family-Friendly',4:'Foodie & Shopping',5:'Adventure & Outdoors',6:'Romantic Couple',7:'Team Social'};
    const _featEn = {'出行类型':'Group Type','自然兴趣':'Nature Interest','旅行天数':'Travel Days','预算等级':'Budget Level','是否国内城市':'Domestic City','目的地大洲':'Region','城市消费水平':'City Cost Tier','美食兴趣':'Food Interest','文化兴趣':'Culture Interest','购物兴趣':'Shopping Interest','历史兴趣':'History Interest','夜生活兴趣':'Nightlife Interest','户外兴趣':'Outdoor Interest','特殊需求':'Special Needs','出行方式':'Travel Mode'};
    const recTypeVal = data.prediction ?? -1;
    const recTypeDisplay = _lang === 'en' ? (_recTypeEn[recTypeVal] || data.recommendation_type_zh) : (data.recommendation_type_zh || '—');
    html += `<div class="sc2">
      <div class="sc2-head"><div class="sc2-head-dot" style="background:var(--green)"></div>${_L('模型决策','Model Decision')}</div>
      <div class="sc2-body">
        <div class="srow"><span class="sk">${_L('推荐类型','Trip Type')}</span><span class="sv org">${recTypeDisplay}</span></div>
        <div class="conf-wrap">
        ...
        ${topF.map(([k, v]) => `<div class="feat">
          <div class="feat-name">${_lang === 'en' ? (_featEn[k] || k) : k}</div>
          <div class="feat-row">
  ...
  if (params.agent_type === 'goal_based') {
    ...
    const _cityMap = I18N[_lang]?.city_map || {};
    const _dCity = _lang === 'en' ? (_cityMap[params.city] || params.city) : params.city;
    const _dGroup = _lang === 'en' ? ({'单人':'Solo','情侣':'Couple','夫妻':'Couple','朋友':'Friends','家庭':'Family','同事':'Team'}[params.group] || params.group) : params.group;
    ...
    html += `<div class="sc2">
      ...
      <div class="tl">
        <div class="tl-item">
          ...
          <div class="tl-content"><div class="tl-label">${_L('需求解析','Request Parsed')}</div><div class="tl-sub">${_dCity} ${params.days}${_L('天','d')} · ${_dGroup} ${numP}${_L('人','ppl')}</div></div>
        </div>
        ${isStreaming
          /* 流式阶段：内嵌工具调用实时日志 */
          ...
          : steps.map((s, i) => {
              ...
              let preview = s.tool === 'search_web'
                ? (s.args?.query || s.result_preview || '')
                : (s.args?.city && s.args?.query
                    ? `${s.args.city} · ${s.args.query}`
                    : (s.args?.query || s.result_preview || ''));
              // English mode: translate preview for tool args
              if (_lang === 'en') {
                preview = preview.replace(/旅行攻略/g, 'travel guide').replace(/景点/g, 'attractions').replace(/餐厅/g, 'restaurants').replace(/餐饮/g, 'dining').replace(/住宿/g, 'accommodation').replace(/交通/g, 'transport').replace(/实用贴士/g, 'tips');
                if (s.args?.city) {
                  preview = preview.replace(s.args.city, _cityMap[s.args.city] || s.args.city);
                }
              }
      ...
      html += `<div class="sc2">
        ...
        <div class="sc2-body">
          ...
          ${top3.map(([label, prob], i) => {
            const enLabel = _lang === 'en' ? {'经济观光':'Budget Sightseeing','文化深度游':'Cultural Deep Dive','奢华体验':'Luxury Experience','亲子家庭游':'Family-Friendly','美食购物游':'Foodie & Shopping','户外探险游':'Adventure & Outdoors','情侣浪漫游':'Romantic Couple','团队社交游':'Team Social'}[label] || label : label;
            return `<div style="margin-bottom:8px">
              <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:3px">
                <span style="font-size:11.5px;font-weight:${i===0?'700':'500'};color:${i===0?'var(--text)':'var(--text2)'}">${enLabel}</span>
  ...
  const _climateTable = _lang === 'en' ? _CLIMATE_EN : _CLIMATE;
  const _weatherNote = data.weather_note || (_climateTable[_lookupCity] && _climateTable[_lookupCity][_tSeason]);
  if (_weatherNote) {
    ...
    html += `<div class="sc2">
      <div class="sc2-head">
        ...
        <span style="margin-left:auto;font-size:10px;color:var(--text3);font-weight:500">${_lang === 'en' ? _seasonLabel : `${_tMonth}月 · ${_seasonLabel}`}</span>
      </div>
      <div class="sc2-body">
  ...
  const _visaTable = _lang === 'en' ? _VISA_EN : _VISA;
  const _visaInfo = _visaTable[_lookupCity] || _visaTable[params.city];
